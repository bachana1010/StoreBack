...
{
    public partial class GetBarcodeWithBalance5 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            BEGIN
                ...
                DECLARE @OrganizationId INT = ' + CAST(@OrganizationId as nvarchar(10)) + ',
                @BranchId INT = ' + CAST(@BranchId as nvarchar(10)) + ',
                @Name NVARCHAR(255) = N''' + @Name + ''',
                @PriceOperator NVARCHAR(1) = N''' + @PriceOperator + ''',
                @PriceValue DECIMAL(18,2) = ' + CAST(@PriceValue as nvarchar(20)) + ',
                @QuantityOperator NVARCHAR(1) = N''' + @QuantityOperator + ''',
                @QuantityValue DECIMAL(18,2) = ' + CAST(@QuantityValue as nvarchar(20)) + ',
                @pageNumber INT = ' + CAST(@pageNumber as nvarchar(10)) + ',
                @pageSize INT = ' + CAST(@pageSize as nvarchar(10)) + ';
